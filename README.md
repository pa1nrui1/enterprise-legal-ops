...
| 日期 | 类型 | 模块 | 更新要点 |
| :--- | :--- | :--- | :--- |
| 2026-06-26 | 新增 | 企业法务运营 | 首次开源 `enterprise-legal-ops` Skill，覆盖合同、HR、公章证照、章程权限、股东出资、本地问库、提醒和飞书日历提醒；同步 8 卷 PRD |
...
本仓库发布的是企业法务运营 Skill 规则、PRD、参考流程和本地脚本，不包含：
